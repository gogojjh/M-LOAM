...
export result_path=$rpg_path/results/simu_jackal_mloam/monte_carlo_SR02/
...
echo "mc_trial 1"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_1/SR02.bag
...
echo "mc_trial 2"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_2/SR02.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 3"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_3/SR02.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 4"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_4/SR02.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 5"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_5/SR02.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 6"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_6/SR02.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 7"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_7/SR02.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 8"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_8/SR02.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 9"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_9/SR02.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 10"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_10/SR02.bag
bash test_main_monte_carlo.sh
