...
export result_path=$rpg_path/results/simu_jackal_mloam/monte_carlo_SR01/
...
echo "mc_trial 1"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_1/SR01.bag
bash test_main_monte_carlo.sh
mv $result_path/traj/stamped_groundtruth.txt $result_path/traj/stamped_groundtruth1.txt
mv $result_path/traj/stamped_mloam_odom_estimate_1.000000.txt $result_path/traj/stamped_mloam_odom_estimate_1.0000001.txt
mv $result_path/traj/stamped_mloam_map_estimate_wo_gf_1.000000_huber_0.txt $result_path/traj/stamped_mloam_map_estimate_wo_gf_1.000000_huber_01.txt
mv $result_path/traj/stamped_mloam_map_wo_ua_estimate_wo_gf_1.000000_huber_0.txt $result_path/traj/stamped_mloam_map_wo_ua_estimate_wo_gf_1.000000_huber_01.txt
mv $result_path/traj/stamped_aloam_odom_estimate.txt $result_path/traj/stamped_aloam_odom_estimate1.txt
mv $result_path/traj/stamped_aloam_map_estimate.txt $result_path/traj/stamped_aloam_map_estimate1.txt
mv $result_path/traj/stamped_floam_map_estimate.txt $result_path/traj/stamped_floam_map_estimate1.txt

echo "mc_trial 2"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_2/SR01.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 3"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_3/SR01.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 4"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_4/SR01.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 5"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_5/SR01.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 6"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_6/SR01.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 7"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_7/SR01.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 8"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_8/SR01.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 9"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_9/SR01.bag
bash test_main_monte_carlo.sh
...
echo "mc_trial 10"
export data_path=$DATA_PATH/lidar_calibration/mloam_dataset/SR_monte_carlo/group_10/SR01.bag
bash test_main_monte_carlo.sh
cp $result_path/traj/stamped_groundtruth.txt $result_path/traj/stamped_groundtruth10.txt
cp $result_path/traj/stamped_mloam_odom_estimate_1.000000.txt $result_path/traj/stamped_mloam_odom_estimate_1.00000010.txt
cp $result_path/traj/stamped_mloam_map_estimate_wo_gf_1.000000_huber_0.txt $result_path/traj/stamped_mloam_map_estimate_wo_gf_1.000000_huber_010.txt
cp $result_path/traj/stamped_mloam_map_wo_ua_estimate_wo_gf_1.000000_huber_0.txt $result_path/traj/stamped_mloam_map_wo_ua_estimate_wo_gf_1.000000_huber_010.txt
cp $result_path/traj/stamped_aloam_odom_estimate.txt $result_path/traj/stamped_aloam_odom_estimate10.txt
cp $result_path/traj/stamped_aloam_map_estimate.txt $result_path/traj/stamped_aloam_map_estimate10.txt
cp $result_path/traj/stamped_floam_map_estimate.txt $result_path/traj/stamped_floam_map_estimate10.txt
