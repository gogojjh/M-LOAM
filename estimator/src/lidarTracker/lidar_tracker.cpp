...
void lidarTracker::trackCloud(const doublt &cur_time, const cloudFeature &cloud_feature)
{
    TicToc t_whole;
    ...
    if (!b_track_inited_)
    {
        b_track_inited_ = true;
        printf("Tracker initialization finished \n");
    }
    else
    {
    ...
    *corner_points_last_ = corner_points_less_sharp;
    *surf_points_last_ = surf_points_less_flat;
    corner_points_last_num_ = corner_points_last_->points.size();
    surf_points_last_num_ = surf_points_last_->points.size();
    kdtree_corner_last_->setInputCloud(corner_points_last_);
    kdtree_sutf_last_->setInputCloud(surf_points_last_);
