    ...
    const Pose &pose_ini)
{
    ...
    *corner_points_last = prev_cloud_feature.find("corner_points_less_sharp")->second; // TODO: use pointer to represent the value
    ...
    *surf_points_flat = cur_cloud_feature.find("surf_points_flat")->second;
    ...
    for (size_t opti_counter = 0; opti_counter < 2; ++opti_counter)
    {
        ...
        // TODO: rewrite it using function
