             ...
             const sensor_msgs::PointCloud2ConstPtr& pc2_right)
{
    ...
    {
        std::vector<double> calib{-0.022141, 0.06658, 0.01914, 0.99735, 0.49015, -0.041563, -0.84056};
    ...
    {
        std::vector<double> calib{-0.11585, 0.18957, 0.67985, 0.69889, 0.42964, 0.67832, -0.93309};
    ...
    {
        std::vector<double> calib{0.072775, 0.13635, -0.74163, 0.65277, 0.4746, -0.72743, -0.96377};
